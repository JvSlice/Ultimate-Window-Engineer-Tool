...
class StickSetupCalcPage extends StatefulWidget {
  const StickSetupCalcPage({super.key});

  @override
  State<StickSetupCalcPage> createState() => _StickSetupCalcPageState();
}

class _StickSetupCalcPageState extends State<StickSetupCalcPage> {
  WeldMaterial _selectedMaterial = weldMaterials.first;
  ThicknessOption _selectedThickness = weldThicknessOptions[1];

  StickRecommendation? get _recommendation {
    return stickData[WeldKey(
  ...
  Widget _resultCard(StickRecommendation rec) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _row('Rod Choices', rec.rodChoices),
  ...
  Widget build(BuildContext context) {
    ...
    return TerminalScaffold(
      title: 'Stick Setup Calc',
      child: SafeArea(
        child: ListView(
          padding: const EdgeInsets.all(16),
          children: [
            const Text(
              'Stick material and thickness calculator',
