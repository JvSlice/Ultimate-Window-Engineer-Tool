...
class GeometryShopPage extends StatefulWidget {
  const GeometryShopPage({super.key});

  @override
  State<GeometryShopPage> createState() => _GeometryShopPageState();
}

class _GeometryShopPageState extends State<GeometryShopPage> {
  final aCtrl = TextEditingController(text: "3.0");
  final bCtrl = TextEditingController(text: "4.0");
  ...
  Widget build(BuildContext context) {
    ...
    final angleA = (a == null || b == null) ? null : (atan2(a, b) * 180 / pi); // angle opposite a
    ...
    return TerminalScaffold(
      ...
      child: Padding(
        ...
        child: ListView(
          children: [
            Text("Right Triangle", style: TextStyle(color: accent, fontSize: 20, fontWeight: FontWeight.w800)),
