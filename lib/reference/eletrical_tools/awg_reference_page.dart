...
class AwgReferencePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final rows = <Map<String, String>>[
      {
        ...
        'diameter': '0.0201"',
        'area': '0.205 mm²',
        'common': 'Small signal / control',
      },
      {
        'awg': '22',
        'diameter': '0.0253"',
        'area': '0.326 mm²',
        'common': 'Light control wiring',
      },
      {
        'awg': '20',
        'diameter': '0.0320"',
        'area': '0.519 mm²',
        'common': 'Low current circuits',
      },
      {
        'awg': '18',
        'diameter': '0.0403"',
        'area': '0.823 mm²',
        'common': 'Control / low power',
      },
      {
        'awg': '16',
        'diameter': '0.0508"',
        'area': '1.31 mm²',
        'common': 'General low voltage',
      },
      {
        'awg': '14',
        'diameter': '0.0641"',
        'area': '2.08 mm²',
        'common': 'Branch / moderate load',
      },
      {
        'awg': '12',
        'diameter': '0.0808"',
        'area': '3.31 mm²',
        'common': 'Heavier branch circuits',
      },
      {
        'awg': '10',
        'diameter': '0.1019"',
        'area': '5.26 mm²',
        'common': 'Higher current load',
      },
      {
        'awg': '8',
        'diameter': '0.1285"',
        'area': '8.37 mm²',
        'common': 'Feeders / larger load',
      },
      {
        'awg': '6',
        'diameter': '0.1620"',
        'area': '13.3 mm²',
        'common': 'High current circuits',
      },
      {
        'awg': '4',
        'diameter': '0.2043"',
        'area': '21.2 mm²',
        'common': 'Large feeders',
      },
      {
        'awg': '2',
        'diameter': '0.2576"',
      ...
      },
      {
        ...
        'diameter': '0.3249"',
        'area': '53.5 mm²',
        'common': 'Battery / feeder cable',
      },
    ];

    Widget refPanel(String title, String body) {
    ...
    Widget terminalPanel(Widget child) {
      final accent = Theme.of(context).colorScheme.primary;
